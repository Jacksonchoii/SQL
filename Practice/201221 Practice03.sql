...
*/
select  lo.location_id "도시ID",
        lo.city "도시명",
        de.department_name "부서명",
        de.department_id "부서ID"
...
--정렬 order by de.department_id asc, co.country_name asc, co.region_id asc 
